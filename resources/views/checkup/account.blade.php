      ...
      <div class="container">
          ...
          <form class="form" enctype="multipart/form-data" method="POST"action="{{ route('edit_account') }}">
            ...
            <div class="info">
              ...
              @include('layouts.errors')
              {{-- Name Input --}}
                <span id="arrow" style="letter-spacing: 1px !important;">الاسم</span>
                <input required class="input" id="name" name="name" type="text" value="{{ auth('patient')->user()->name }}" disabled>
              {{-- Email Input  --}}
                <span id="arrow" style="letter-spacing: 1px !important;">البريد الالكتروني</span>
                <input  required class="input" id="email" name="email" type="email" value="{{ auth('patient')->user()->email }}" disabled>
              {{-- Password Input  --}}
                <span id="arrow_password" class="arrow_password" style="letter-spacing: 1px !important;display: none;">كلمة المرور</span>
                <input class="input" style="display: none;" id="password" type="password" >
              {{-- Password Confiramtion    --}}
                <span id="arrow_confirmation" style="letter-spacing: 1px !important;display: none;" class="arrow_confirmation">تاكيد كلمة المرور</span>
                <input class="input" style="display: none;" id="password_confirmation" type="password">
              {{-- Image Input file    --}}
              <span id="arrow_image" style="letter-spacing: 1px !important;display: none;" class="arrow_image">الصورة الشخصية للحساب</span>
              <input class="input" style="display: none;" id="image" name="image" accept="image/*" type="file">
          ...
          <div class="log">
          <a>
            <button class="submit" id="btn_submit" onclick="toggle();" type="submit" style="letter-spacing: 1px !important;width: fit-content;">تعديل</button>
          </a>
          </div>
      </div>
    </div>
